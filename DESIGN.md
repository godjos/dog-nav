...
- Direction: 直接参考 Homepage 的紧凑顶部信息栏、sky 蓝/浅色主题、统一紧凑小卡和弹性分组；Mirza（参考 DogNav 改版）仍使用自己的站点数据与单页操作。
...
- Shape/radius/elevation: 全部站点统一 6px 圆角紧凑小卡（24px 图标盒、46px 最小行高、7px 垂直内距、8px 行内图标间距）；低对比描边与轻阴影，hover 只改变表面亮度
